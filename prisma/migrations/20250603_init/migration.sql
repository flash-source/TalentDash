...
ALTER TABLE "Salary" ADD CONSTRAINT "Salary_company_id_fkey"
  FOREIGN KEY ("company_id") REFERENCES "Company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "Salary" ADD CONSTRAINT "salary_confidence_range"
  CHECK (confidence_score >= 0.0 AND confidence_score <= 1.0);

ALTER TABLE "Salary" ADD CONSTRAINT "salary_experience_range"
